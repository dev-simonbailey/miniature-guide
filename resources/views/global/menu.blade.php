<div class="links" style='border:1px solid grey'>
    <a href="/">Welcome</a>
</div>
<div>
    <fieldset class="links" style='border:1px solid grey'>
        <legend>Admin</legend>
        <a href="/admin/ilog-add">Log Interaction</a>
...
<div>
    <fieldset class="links" style='border:1px solid grey'>
        ...
        <a href="/search/orders">Orders</a>
        <a href="/search/by-part">Orders by Part</a>
        <a href="/search/customers">Customers</a>
        <a href="/search/stock-check">Stock Check</a>
    </fieldset>
</div>
<div>
    <fieldset class="links" style='border:1px solid grey'>
        <legend>Dashboards</legend>
        <a href="/dashboard/bike-wip">Bike WIP</a>
        <a href="/dashboard/pac-wip">PAC WIP</a>
        <a href="/dashboard/pick-wip">Pick WIP</a>
        <a href="/dashboard/returns">Returns</a>
    </fieldset>
</div>
<div>
    <fieldset class="links" style='border:1px solid grey'>
        <legend>Workshop</legend>
        <a href="/workshop/add-inbound-build">Add Inbound Build</a>
        <a href="/workshop/add-outbound-build">Add Outbound Build</a>
        <a href="/workshop/add-pdi">Add PDI</a>
        <a href="/workshop/add-new-pack">Add New Pack</a>
    </fieldset>
</div>
<div>
    <fieldset class="links" style='border:1px solid grey'>
