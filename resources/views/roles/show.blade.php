            ...
            @foreach ($roles as $role)
                <tr>
                    ...
                    @else
                        <td class="bg-danger text-white">Not Allowed</td>
                    @endcan
                    <td style="width:150px;border: 1px solid Transparent!important;background-color: #ffffff"><a
                            href='/roles/edit/{{ $role->id }}' class="btn btn-success" style="min-width:120px;">Edit</a>
                    </td>
            @endforeach
            </tbody>
        </table>
